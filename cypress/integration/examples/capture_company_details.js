describe ('QA Engineer - Reach - Capture company details on company names - Home screen', () => {
    ...
    it('Click on first company, check page and capture company details', () => {
        ...
        cy.writeFile('Alan_Pharmaceutical.json', { Name: 'Alan Pharmaceuticals', address: 'Highgate Business Centre, 33 Greenwood Place, London, London, NW5 1LB, UK', telephone: '0207 284 2887', email: 'info@alanpharma.com', website: 'http://www.alanpharmaceuticals.com', fax: '0207 267 9841', directline: '0207 284 2887'})
    ...
    it('Click on second company, check page and capture company details', () => {
        ...
        cy.writeFile('Aspen.json', { Name: 'Aspen', address: '3016 Lake Drive, Citywest Business Campus, Dublin 24, Ireland', telephone: '+ 44 1748 828 391', email: 'info@alanpharma.com', directline: '0800 0087 392'})
